...
class ServiceProvider
{
    ...
    /** @var Collection<int, ProviderScoreHistory> */
    #[ORM\OneToMany(targetEntity: ProviderScoreHistory::class, mappedBy: 'serviceProvider', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $scoreHistory;

    /** @var Collection<int, ServiceProposal> */
    #[ORM\OneToMany(targetEntity: ServiceProposal::class, mappedBy: 'serviceProvider', cascade: ['persist'], orphanRemoval: false)]
    private Collection $serviceProposals;

    public function __construct()
    {
        $this->serviceBookings = new ArrayCollection();
        $this->scoreHistory = new ArrayCollection();
    ...
    /** @return Collection<int, ProviderScoreHistory> */
    public function getScoreHistory(): Collection
    {
