...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\EmailVerificationCodeType' => ['privates', 'App\\Form\\EmailVerificationCodeType', 'getEmailVerificationCodeTypeService', true],
            'App\\Form\\EventType' => ['privates', 'App\\Form\\EventType', 'getEventTypeService', true],
            'App\\Form\\OrderStatusType' => ['privates', 'App\\Form\\OrderStatusType', 'getOrderStatusTypeService', true],
            ...
            'App\\Form\\RequestPasswordResetType' => ['privates', 'App\\Form\\RequestPasswordResetType', 'getRequestPasswordResetTypeService', true],
            'App\\Form\\ResetPasswordType' => ['privates', 'App\\Form\\ResetPasswordType', 'getResetPasswordTypeService', true],
            'App\\Form\\ServiceBookingType' => ['privates', 'App\\Form\\ServiceBookingType', 'getServiceBookingTypeService', true],
            'App\\Form\\ServiceProposalType' => ['privates', 'App\\Form\\ServiceProposalType', 'getServiceProposalTypeService', true],
            'App\\Form\\ServiceProviderType' => ['privates', 'App\\Form\\ServiceProviderType', 'getServiceProviderTypeService', true],
            'App\\Form\\ServiceRequestType' => ['privates', 'App\\Form\\ServiceRequestType', 'getServiceRequestTypeService', true],
            'App\\Form\\SponsorRequestType' => ['privates', 'App\\Form\\SponsorRequestType', 'getSponsorRequestTypeService', true],
            'App\\Form\\SponsorType' => ['privates', 'App\\Form\\SponsorType', 'getSponsorTypeService', true],
            'App\\Form\\SponsorshipPackageType' => ['privates', 'App\\Form\\SponsorshipPackageType', 'getSponsorshipPackageTypeService', true],
            ...
            'App\\Form\\EmailVerificationCodeType' => '?',
            'App\\Form\\EventType' => '?',
            'App\\Form\\OrderStatusType' => '?',
            'App\\Form\\OrderType' => '?',
            ...
            'App\\Form\\ServiceBookingType' => '?',
            'App\\Form\\ServiceProposalType' => '?',
            'App\\Form\\ServiceProviderType' => '?',
            'App\\Form\\ServiceRequestType' => '?',
            'App\\Form\\SponsorRequestType' => '?',
            'App\\Form\\SponsorType' => '?',
            'App\\Form\\SponsorshipPackageType' => '?',
            'App\\Form\\TicketType' => '?',
