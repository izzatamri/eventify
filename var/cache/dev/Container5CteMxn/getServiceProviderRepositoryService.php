 ...
 */
class getServiceProviderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ServiceProviderRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceProviderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceProviderRepository.php';

        return $container->privates['App\\Repository\\ServiceProviderRepository'] = new \App\Repository\ServiceProviderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
