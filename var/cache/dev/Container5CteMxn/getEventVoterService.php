...
{
    /**
     * Gets the private '.debug.security.voter.App\Security\EventVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'EventVoter.php';

        $a = ($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService'));

        if (isset($container->privates['.debug.security.voter.App\\Security\\EventVoter'])) {
            return $container->privates['.debug.security.voter.App\\Security\\EventVoter'];
        }
        ...
        $instance = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Security\EventVoter($a), $b);

        if (isset($container->privates['.debug.security.voter.App\\Security\\EventVoter'])) {
            return $container->privates['.debug.security.voter.App\\Security\\EventVoter'];
        }

        return $container->privates['.debug.security.voter.App\\Security\\EventVoter'] = $instance;
    }
}
