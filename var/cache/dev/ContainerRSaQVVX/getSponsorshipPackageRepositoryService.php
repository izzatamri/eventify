 ...
 */
class getSponsorshipPackageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SponsorshipPackageRepository' shared autowired service.
     *
     * @return \App\Repository\SponsorshipPackageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SponsorshipPackageRepository.php';

        return $container->privates['App\\Repository\\SponsorshipPackageRepository'] = new \App\Repository\SponsorshipPackageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
