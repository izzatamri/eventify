 ...
 */
class getServiceProposalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ServiceProposalRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceProposalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceProposalRepository.php';

        return $container->privates['App\\Repository\\ServiceProposalRepository'] = new \App\Repository\ServiceProposalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
