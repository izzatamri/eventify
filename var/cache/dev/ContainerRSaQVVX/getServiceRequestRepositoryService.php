 ...
 */
class getServiceRequestRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceRequestRepository.php';

        return $container->privates['App\\Repository\\ServiceRequestRepository'] = new \App\Repository\ServiceRequestRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
