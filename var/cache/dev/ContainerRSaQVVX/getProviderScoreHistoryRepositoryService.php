 ...
 */
class getProviderScoreHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProviderScoreHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\ProviderScoreHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProviderScoreHistoryRepository.php';

        return $container->privates['App\\Repository\\ProviderScoreHistoryRepository'] = new \App\Repository\ProviderScoreHistoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
