...
class __TwigTemplate_7ff1ed0c37ba4140fe8534efa2416c29 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/events/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/events/index.html.twig"));
    ...
    public function block_page_breadcrumb(array $context, array $blocks = []): iterable
    {
        ...
        yield "<li class=\"breadcrumb-item active\">Events</li>";
...
\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"searchEventList\" placeholder=\"Search by title or organizer...\" value=\"";
        // line 26
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("search_q", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["search_q"]) || array_key_exists("search_q", $context) ? $context["search_q"] : (function () { throw new RuntimeError('Variable "search_q" does not exist.', 26, $this->source); })()), "")) : ("")), "html", null, true);
...
\t\t\t\t\t\t<a href=\"";
        ...
        yield "\" class=\"btn btn-success\" target=\"_blank\" style=\"border-radius: 8px; padding: 0.5rem 1.25rem; font-weight: 600;\">
\t\t\t\t\t\t\t<i class=\"ri-external-link-line me-1 align-bottom\"></i>View on Site
\t\t\t\t\t\t</a>
...
\t\t\t\t";
        // line 48
        yield from $this->load("admin/events/_events_list.html.twig", 48)->unwrap()->yield(CoreExtension::merge($context, ["events" => (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 48, $this->source); })())]));
        // line 49
        yield "\t\t\t</div>
\t\t</div>
\t</div>
...
\t\t\t// Search via AJAX
\t\t\tvar searchEl = document.getElementById('searchEventList');
\t\t\tvar eventlist = document.getElementById('eventlist');
\t\t\tif (searchEl && eventlist) {
\t\t\t\tvar debounceTimer;
...
\t\t\t\t\tvar url = (window.location.pathname || '/admin/events') + (q ? '?q=' + encodeURIComponent(q) : '');
\t\t\t\t\teventlist.style.opacity = '0.7';
\t\t\t\t\teventlist.style.pointerEvents = 'none';
...
\t\t\t\t\t\t})
\t\t\t\t\t\t.catch(function () {
\t\t\t\t\t\t\teventlist.innerHTML = '<div class=\"col-12 text-center py-5\"><p class=\"text-danger\">Error loading events.</p></div>';
\t\t\t\t\t\t})
\t\t\t\t\t\t.finally(function () {
\t\t\t\t\t\t\teventlist.style.opacity = '';
\t\t\t\t\t\t\teventlist.style.pointerEvents = '';
\t\t\t\t\t\t});
\t\t\t\t}
\t\t\t\tsearchEl.addEventListener('input', debounce(loadEvents, 320));
\t\t\t}
\t\t})();
\t</script>
";
    ...
    {
        return "admin/events/index.html.twig";
    }
    ...
    {
        return array (  250 => 55,  237 => 54,  223 => 49,  221 => 48,  202 => 32,  193 => 26,  185 => 20,  175 => 16,  172 => 15,  167 => 14,  157 => 10,  154 => 9,  149 => 8,  136 => 7,  113 => 5,  90 => 4,  67 => 3,  44 => 1,);
    }
...
{% block page_breadcrumb %}<li class=\"breadcrumb-item active\">Events</li>{% endblock %}
...
\t\t\t\t<div class=\"col-sm-4\">
\t\t\t\t\t<div class=\"search-box\">
\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"searchEventList\" placeholder=\"Search by title or organizer...\" value=\"{{ search_q|default('') }}\" autocomplete=\"off\" style=\"border-radius: 8px; padding: 0.5rem 2.5rem 0.5rem 1rem;\">
\t\t\t\t\t\t<i class=\"ri-search-line search-icon\"></i>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"col-sm-auto ms-auto\">
\t\t\t\t\t<div class=\"list-grid-nav hstack gap-2\">
\t\t\t\t\t\t<a href=\"{{ path('app_events') }}\" class=\"btn btn-success\" target=\"_blank\" style=\"border-radius: 8px; padding: 0.5rem 1.25rem; font-weight: 600;\">
\t\t\t\t\t\t\t<i class=\"ri-external-link-line me-1 align-bottom\"></i>View on Site
\t\t\t\t\t\t</a>
\t\t\t\t\t\t<div class=\"btn-group\" role=\"group\" style=\"border-radius: 8px; overflow: hidden;\">
\t\t\t\t\t\t\t<button type=\"button\" id=\"grid-view-button\" class=\"btn btn-outline-secondary active\" title=\"Grid\" style=\"padding: 0.5rem 0.75rem;\"><i class=\"ri-grid-fill\"></i></button>
...
\t\t<div class=\"col-lg-12\">
\t\t\t<div id=\"eventlist\">
\t\t\t\t{% include 'admin/events/_events_list.html.twig' with { events: events } %}
\t\t\t</div>
\t\t</div>
\t</div>
{% endblock %}
...
\t</script>
{% endblock %}
", "admin/events/index.html.twig", "C:\\Users\\HP\\Downloads\\ismail_integ\\ismail_integ\\eventify-integration_final_gestion_user_and_gestion_events_tickets_and_reclamation\\templates\\admin\\events\\index.html.twig");
    }
}
