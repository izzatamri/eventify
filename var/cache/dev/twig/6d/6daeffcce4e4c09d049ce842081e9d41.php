...
class __TwigTemplate_dac367cca3a92163cb76071e0592c27f extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "order/create.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "order/create.html.twig"));
    ...
    public function block_page_breadcrumb(array $context, array $blocks = []): iterable
    {
        ...
        yield "</a> <i class=\"fa-solid fa-angle-right\"></i> Buy ticket";
...
\t\t\t\t\t<h2 class=\"h5 fw-bold mb-2\">Buy ticket</h2>
\t\t\t\t\t<p class=\"text-muted small mb-4\">";
        // line 14
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["event"]) || array_key_exists("event", $context) ? $context["event"] : (function () { throw new RuntimeError('Variable "event" does not exist.', 14, $this->source); })()), "title", [], "any", false, false, false, 14), "html", null, true);
        yield "</p>
...
\t\t\t\t\t\t";
        // line 17
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "ticket", [], "any", false, false, false, 17), 'row');
        yield "
\t\t\t\t\t\t";
        // line 18
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "quantity", [], "any", false, false, false, 18), 'row');
        yield "
\t\t\t\t\t\t<div class=\"d-flex gap-2 mt-4\">
\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary\">Place order</button>
\t\t\t\t\t\t\t<a href=\"";
        // line 21
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_event_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["event"]) || array_key_exists("event", $context) ? $context["event"] : (function () { throw new RuntimeError('Variable "event" does not exist.', 21, $this->source); })()), "id", [], "any", false, false, false, 21)]), "html", null, true);
...
";
    ...
    {
        return array (  186 => 23,  181 => 21,  175 => 18,  171 => 17,  167 => 16,  162 => 14,  154 => 8,  141 => 7,  114 => 5,  91 => 4,  66 => 3,  43 => 1,);
    }
...
{% block title %}Buy ticket - {{ event.title }} - Eventify{% endblock %}
{% block page_heading %}Buy ticket{% endblock %}
{% block page_breadcrumb %}<a href=\"{{ path('app_event_show', { id: event.id }) }}\">{{ event.title }}</a> <i class=\"fa-solid fa-angle-right\"></i> Buy ticket{% endblock %}
...
{% endblock %}
", "order/create.html.twig", "C:\\Users\\HP\\Downloads\\ismail_integ\\ismail_integ\\eventify-integration_final_gestion_user_and_gestion_events_tickets_and_reclamation\\templates\\order\\create.html.twig");
    }
}
