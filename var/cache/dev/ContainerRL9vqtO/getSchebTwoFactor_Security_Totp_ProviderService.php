...
class getSchebTwoFactor_Security_Totp_ProviderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['scheb_two_factor.security.totp.default_form_renderer'] ?? $container->load('getSchebTwoFactor_Security_Totp_DefaultFormRendererService'));

        if (isset($container->privates['scheb_two_factor.security.totp.provider'])) {
            return $container->privates['scheb_two_factor.security.totp.provider'];
        }

        $instance = new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\Totp\TotpAuthenticatorTwoFactorProvider($a, $b);

        if (isset($container->privates['scheb_two_factor.security.totp.provider'])) {
            return $container->privates['scheb_two_factor.security.totp.provider'];
        }

        return $container->privates['scheb_two_factor.security.totp.provider'] = $instance;
    }
}
