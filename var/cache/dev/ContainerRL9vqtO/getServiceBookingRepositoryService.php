 ...
 */
class getServiceBookingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ServiceBookingRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceBookingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceBookingRepository.php';

        return $container->privates['App\\Repository\\ServiceBookingRepository'] = new \App\Repository\ServiceBookingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
