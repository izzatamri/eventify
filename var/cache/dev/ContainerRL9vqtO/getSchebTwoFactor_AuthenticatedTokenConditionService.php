...
class getSchebTwoFactor_AuthenticatedTokenConditionService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.authenticated_token_condition'] = new \ReflectionClass('Scheb\TwoFactorBundle\Security\TwoFactor\Condition\AuthenticatedTokenCondition')->newLazyGhost(static function ($proxy) use ($container) { self::do($container, $proxy); });
        }
