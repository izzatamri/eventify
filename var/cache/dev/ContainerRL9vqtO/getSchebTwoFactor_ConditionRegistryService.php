...
class getSchebTwoFactor_ConditionRegistryService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.condition_registry'] = new \ReflectionClass('Scheb\TwoFactorBundle\Security\TwoFactor\Condition\TwoFactorConditionRegistry')->newLazyGhost(static function ($proxy) use ($container) { self::do($container, $proxy); });
        }
